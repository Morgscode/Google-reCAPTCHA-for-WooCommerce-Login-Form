...
class Recaptcha_For_Wc_Forms
{
	 ...
	 * @since    1.0.0
	 * @access   protected
	 * @var      Recaptcha_For_Wc_Forms_Loader    $loader    Maintains and registers all hooks for the plugin.
	 */
	protected $loader;
	...
	public function __construct()
	{
		...
		$this->plugin_name = 'recaptcha-for-wc-forms';
	 ...
	 *
	 * - Recaptcha_For_Wc_Forms_Loader. Orchestrates the hooks of the plugin.
	 * - Recaptcha_For_Wc_Forms_i18n. Defines internationalization functionality.
	 * - Recaptcha_For_Wc_Forms_Admin. Defines all hooks for the admin area.
	 * - Recaptcha_For_Wc_Forms_Public. Defines all hooks for the public side of the site.
	 *
	 ...
	 *
	 * Uses the Recaptcha_For_Wc_Forms_i18n class in order to set the domain and to register the hook
	 * with WordPress.
	 *
	 * @since    1.0.0
	 * @access   private
